...
<?php
	$query="SELECT * FROM `return_product` where return_id=1" ;
...
if(isset($_POST['submit'])){
   ...
   $query_up=mysqli_query($conn, "UPDATE `return_product` set description='$description', timestamp=NOW()  where return_id = 1 ") or die(mysqli_error());
